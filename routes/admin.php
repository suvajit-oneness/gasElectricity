...
Route::group(['prefix' => 'setting'], function () {
	...
	Route::get('individual-utility', 'Admin\AdminController@individualUtility')->name('admin.setting.update_individual_utility');
	Route::get('individual-utility/{id}/delete', 'Admin\AdminController@deleteIndividualUtility')->name('admin.setting.individual_utility.delete');
	Route::post('individual-utility', 'Admin\AdminController@updateIndividualUtility')->name('admin.setting.individual_utility');
});
