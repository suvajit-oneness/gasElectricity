...
@endif
<section class="momentum_wrap d-none">
	<div class="container">
		<div class="row">
			<div class="col-12">
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-4 text-end">
				<a href="{{route('product.listing',$newURL)}}" class="btn plan_details_btn"> <i class="fa-solid fa-arrow-left"></i> Go back to search result</a>
			</div>
		</div>
		<div class="row">
			<div class="col-12">
...
{{-- if($productData->terms_condition != '') --}}
	<section class="terms_condition_wrap d-none">
		<div class="container">
			<div class="row">
				<div class="col-12">
