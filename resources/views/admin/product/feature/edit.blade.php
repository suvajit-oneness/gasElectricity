            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="mb-0">Edit Product Feature
                        <a class="headerbuttonforAdd" href="{{route('admin.product.feature',$feature->product_id)}}"><i class="fa fa-step-backward" aria-hidden="true"></i>BACK</a>
                    </h5>
                    <!-- <p>This example shows FixedHeader being styled by the Bootstrap 4 CSS framework.</p> -->
                </div>
                <div class="card-body">
                    <form method="post" action="{{route('admin.product.feature.update',[$feature->product_id,$feature->id])}}" enctype="multipart/form-data">
                        @csrf
