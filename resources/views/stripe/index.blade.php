        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" action="{{ route('stripe.payment.form_submit') }}" method="post" class="require-validation" data-cc-on-file="false" data-stripe-publishable-key="pk_test_TYooMQauvdEDq54NiTphI7jx" id="payment-form">
                        @csrf
...
$(function() {
  ...
  function stripeResponseHandler(status, response) {
        if (response.error) {
            ...
            $form.append("<input type='hidden' name='amount' value='{{$data['price']}}'/>");
            $form.append("<input type='hidden' name='redirectURL' value='{{$data['redirectUrl']}}'/>");
            $form.get(0).submit();
        }
    }
